...
function PokemonInfo({pokemonName}) {
  ...
  React.useEffect(() => {
    ...
    /*
    // Essa abordagem não funciona pq o JS trabalha de forma ASSÍNCRONA
    ...
    */
    ...
    // Tecnicamente, uma função assíncrona retorna um objeto do tipo Promise(promesso).
    // Uma promise suporta dois callback, um para quando a execução assíncrona dá certa
    ...
    .catch( // Calback para quando dá errado ("do mal")
